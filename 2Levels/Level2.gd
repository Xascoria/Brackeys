...
var level_contents = [
	#Friendly
	[
		["soldier", "Grey", 2, "ALIVE", true, Vector2(2,4)], 
		["soldier", "Spot", 1, "ALIVE", true, Vector2(3,3)],
		["soldier", "Alc", 1, "ALIVE", true, Vector2(5,3)],
	],
	#Enemies
	[
		["soldier", "BT73", 1, [["attack", Vector2(0,1)], ["move", Vector2(0,-1)], ["move", Vector2(0,-1)],["move", Vector2(0,-1)], ["rest", Vector2(0,0)]]
		,true , Vector2(2,3)],
		["soldier", "YP182", 3, [["attack", Vector2(0,1)], ["attack", Vector2(0,1)], ["move", Vector2(0,-1)], ["move", Vector2(0,-1)], ["rest", Vector2(0,0)]]
		,true , Vector2(3,2)],
		["soldier", "PS05", 2, [["attack", Vector2(1,0)], ["move", Vector2(0,-1)], ["move", Vector2(0,-1)],["move", Vector2(0,-1)], ["rest", Vector2(0,0)]]
		,true , Vector2(4,3)],
		["soldier", "AC48", 2, [["attack", Vector2(-1,0)], ["move", Vector2(0,-1)], ["move", Vector2(0,-1)],["move", Vector2(0,-1)], ["rest", Vector2(0,0)]]
		,true , Vector2(6,3)]
	],
	#Dates
	["8 December 2020", "7 December 2020", "6 December 2020", "5 December 2020", "4 December 2020"],
	#Victory condition: [friendly, position, health]
	[[false, Vector2(2,0), 3], [false, Vector2(3,0), 3], [false, Vector2(4,0), 3], [false, Vector2(6,0), 3], 
	[true, Vector2(2,7), 3], [true, Vector2(3,6), 3], [true, Vector2(5,6), 3]
	],
	#Obstacles
	[[3, [4,5]],[4, [1,1]],[1, [1,7]]],
	#scale and details
	[0.77, "BATTLE REPORT ON DECEMBER 4\n\nSIR, THE SITUATION ON THE FRONT ISN'T LOOKING GOOD, IT'S LOOKING BAD, WHICH ISN'T GOOD."]
]
...
func _ready():
	...
	$Map.set_map_size(map_size)
	setup_level()
	
	$UI.update_date(level_contents[2][turn_count])
	$UI.setup_bf_details(map_size, level_contents[3], level_contents[4], level_contents[5][0], level_contents[5][1])
